        ...
        static CustomColors[] CustomColorsArray = new[]
{
        ...
        public static byte[] Red = ColorToBgrArray(Color.Red);
        public static byte[] Black = ColorToBgrArray(Color.Black);
        public static byte[] White = ColorToBgrArray(Color.White);
        public static byte[] Green = ColorToBgrArray(Color.Green);
        public static byte[] Blue = ColorToBgrArray(Color.Blue);
        public static byte[] Yellow = ColorToBgrArray(Color.Yellow);
        public static byte[] Gray = ColorToBgrArray(Color.Gray);
    }
}
